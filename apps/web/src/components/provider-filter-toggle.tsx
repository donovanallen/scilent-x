...
export interface ProviderFilterToggleProps {
  ...
  /** When false, hides the "All providers" option. Defaults to true. */
  showAllOption?: boolean;
  /** When true, renders nothing (e.g. single-provider locked mode). */
  hidden?: boolean;
}
...
export function ProviderFilterToggle({
  selectedProvider,
  onProviderChange,
  enabledProviders,
  showAllOption = true,
  hidden = false,
}: ProviderFilterToggleProps) {
...
/** @deprecated Use ProviderFilterToggle instead. */
export const SearchProviderToggle = ProviderFilterToggle;
