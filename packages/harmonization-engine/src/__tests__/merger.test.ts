...
import { ReleaseMerger, ArtistMerger } from "../harmonizer/merger.js";
import type { HarmonizedRelease, HarmonizedArtist } from "../types/index.js";
...
describe("ReleaseMerger", () => {
  ...
  it("merges external IDs from multiple sources", () => {
    const release1 = createRelease({
      ...
      sources: [{ provider: "musicbrainz", id: "mb-id", fetchedAt: new Date() }],
    });
