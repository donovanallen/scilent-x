...
/**
   ...
   * `prisma.artistFollow`: Exposes CRUD operations for the **ArtistFollow** model.
    ...
    * ```
    */
  get artistFollow(): Prisma.ArtistFollowDelegate<ExtArgs, { omit: OmitOpts }>;
}
